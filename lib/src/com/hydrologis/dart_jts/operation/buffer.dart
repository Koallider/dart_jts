...
//BufferDebug.saveBuffer(geomBuf);
  ...
  BufferBuilder createBufferBullder() {
    ...
    bufBuilder.isInvertOrientation = isInvertOrientation;
    return bufBuilder;
  }
...
class BufferCurveSetBuilder {
  ...
  List curveList = List.empty(growable:true);
      ...
      BufferParameters bufParams)
  {
    ...
    this.distance = distance;
    this.curveBuilder = OffsetCurveBuilder(precisionModel, bufParams);
  }
  ...
  void addCurve(List<Coordinate>? coord, int leftLoc, int rightLoc)
  {
    ...
    SegmentString e = new NodedSegmentString(coord,
        new Label.args4(0, Location.BOUNDARY, leftLoc, rightLoc));
    curveList.add(e);
  }
  ...
  static final int MAX_INVERTED_RING_SIZE = 9;
  static final int INVERTED_CURVE_VERTEX_FACTOR = 4;
  static final double NEARNESS_FACTOR = 0.99;
   ...
   */
  static bool isRingCurveInverted(List<Coordinate> inputPts, double distance, List<Coordinate> curvePts) {
   ...
   * @return
   */
  static bool isTriangleErodedCompletely(
